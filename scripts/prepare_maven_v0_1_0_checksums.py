#!/usr/bin/env python3
"""Prepare strict Maven sidecars for the exact immutable RouteContract v0.1.0.
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "RouteContract v0.1.0 installed coordinate."
        )
    )
    parser.add_argument(
        "--repository",
...
def run(argv: list[str]) -> int:
    ...
    print(f"Prepared exact RouteContract v0.1.0 Maven sidecars: {coordinate}")
