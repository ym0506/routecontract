...
- Show public v0.1.3 Central coordinates, test scope, Java 17 and exact ShardingSphere-JDBC 5.5.3 next to installation. Describe synchronous non-batch PreparedStatement capture and retain the business assertion.
...
- Keep release 0.1.3, historical v0.1.2 demonstrations and unreleased 0.2 work distinct. No production-readiness, benchmark, adopter or broad-version claims.
