...
Other current evidence uses the same producer and nine-payload receipt
`9a4d745ff11508a8ab08dd8bced6a7893d8f6e6ff5baab34b3445aea652ba49c`:

| Existing scope | Current producer evidence |
| --- | --- |
| Runtime boundaries, manual mixed anchors and lifecycle | [28 + 14 + 6 native cases](evidence/current-runtime-and-installation-5800ed2-2026-09-14.md#completed-native-executions) |
| Artifact contents and manifest unit results | [JAR inspection and retained 606 + 22 cases](evidence/current-runtime-and-installation-5800ed2-2026-09-14.md#artifact-content-and-retained-manifest-unit-evidence); not a new packaged unit execution |
| Maven A-24 | [All four Java 17/21 and exact-runtime profiles](evidence/a24-maven-5800ed2-2026-09-14.md) |
| Gradle A-24 | [All 28 Groovy/Kotlin cases on Java 17](evidence/current-runtime-and-installation-5800ed2-2026-09-14.md#gradle-installation-observations), including the explicit frozen-input replay |
| Specialized A-15 / A-17 dual boundaries | [Incomplete current gate](evidence/dual-resolver-current-5800ed2-2026-09-14.md); missing native intrinsic paths remain a failure |
| A-26 API migration | [Six MySQL cases and documented compatibility probes](evidence/public-api-migration-5800ed2-2026-09-14.md) |
| A-27 / A-29 with public 0.1.4 included | [46 Gradle, 56 Maven and 76 fresh-JVM cases](evidence/legacy-014-upgrade-2026-09-14.md) |

Each record specifies its own complete scope and remaining conditions. Historical
results are not counted again as current executions. Release acceptance remains
incomplete while its required human review and publication conditions are open.
